...
```{r densite, echo=FALSE, fig.cap = "Densité"}
source("source/densite.R")
# Map
library(ggplot2)
source("source/functions/ggplot.R")
ggplot() +
  geom_sf(
    data = departement_COM
  ) +
  geom_sf(
    data = commune_IRIS,
    mapping = aes(fill = as.numeric(POPDENS))
  ) +
...
# geo_levels = c("NAT", "DEP", "COM", "GROUP", "IRIS")
geo_levels_demog = c("COM", "GROUP", "IRIS")

# Calculs
source("source/demographie.R")
...
# Niveaux géographiques à afficher, parmi :
# geo_levels = c("NAT", "DEP", "COM", "GROUP", "IRIS")
geo_levels_csp = c("COM", "GROUP", "IRIS")
...
# Niveaux géographiques à afficher, parmi :
# geo_levels = c("NAT", "DEP", "COM", "GROUP", "IRIS")
geo_levels_dipl = c("COM", "GROUP", "IRIS")

# Calculs
source("source/diplomes.R")
...
# Niveaux géographiques à afficher, parmi :
# geo_levels = c("NAT", "DEP", "COM", "GROUP", "IRIS")
geo_levels_etud = c("COM", "GROUP", "IRIS")

# Calculs
source("source/etudiants.R")
